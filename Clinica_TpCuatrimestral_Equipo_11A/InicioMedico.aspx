...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container mt-4">
        ...
        <p class="text-muted">Lunes, 29 de octubre de 2025</p>
        ...
        <div class="card shadow-sm border-0">
            <div class="card-body">
                <div class="d-flex justify-content-between mb-3">
                    <h5 class="fw-bold mb-0">Turnos del día: 29/10/2025 </h5>
                ...
                <table class="table align-middle table-hover">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>Programado</td>
                            <td>
                                <!-- Botón para ver historial del paciente -->
                                <button type="button" class="btn btn-outline-primary btn-sm" title="Ver historial del paciente" onclick="location.href='HistoriaClinicaMedico.aspx';">
                                    <i class="bi bi-person"></i>
                                </button>

                                <!-- Botón para ver detalles del turno -->
                                <button type="button" class="btn btn-outline-secondary btn-sm" title="Ver detalles del turno" onclick="location.href='DetalleTurnoMedico.aspx';">
                                    <i class="bi bi-eye"></i>
                                </button>
